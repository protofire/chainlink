...
import (
	...
	testoffchainaggregator2 "github.com/smartcontractkit/chainlink/core/external/libocr/gethwrappers2/testocr2aggregator"
	ocrnetworking "github.com/smartcontractkit/chainlink/core/external/libocr/networking"
	confighelper2 "github.com/smartcontractkit/chainlink/core/external/libocr/offchainreporting2/confighelper"
	ocrtypes2 "github.com/smartcontractkit/chainlink/core/external/libocr/offchainreporting2/types"
...
func setupNodeOCR2(t *testing.T, owner *bind.TransactOpts, port uint16, dbName string, b *backends.SimulatedBackend) (*cltest.TestApplication, string, common.Address, ocr2key.KeyBundle, *configtest.TestGeneralConfig) {
	...
	tx := types.NewTransaction(n, transmitter, big.NewInt(1000000000000000000), 21000, big.NewInt(1000000000), nil, nil, nil, nil)
