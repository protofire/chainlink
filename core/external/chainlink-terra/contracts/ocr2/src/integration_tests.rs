...
fn transmit_happy_path() {
    ...
    // https://github.com/smartcontractkit/chainlink/core/external/chainlink-terra/issues/20
    ...
    // https://github.com/smartcontractkit/chainlink/core/external/chainlink-terra/issues/19
