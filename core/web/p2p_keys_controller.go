...
func NewP2pKeysController(app chainlink.Application) P2PKeysController {
	return P2PKeysController{newController(app)}
}
...
func (p2pkc *P2PKeysController) Import(c *gin.Context) {
	defer p2pkc.lggr.ErrorIfClosing(c.Request.Body, "Import ")
...
func (p2pkc *P2PKeysController) Export(c *gin.Context) {
	defer p2pkc.lggr.ErrorIfClosing(c.Request.Body, "Export request body")
